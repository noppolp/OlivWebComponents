...
module.exports = (grunt) ->
    ...
    # dynamic port
    SERVER_PORT = grunt.option('port') || 9000
    LIVERELOAD_PORT = SERVER_PORT + 10000
    ...
    grunt.initConfig
        ...
        connect:
            ...
            livereload:
                options:
                    middleware: (connect) ->
                        [lrSnippet(port: LIVERELOAD_PORT), mountFolder(connect, ".tmp"), mountFolder(connect, yeomanConfig.app)]
            docs:
                options:
                    middleware: (connect) ->
                        [lrSnippet(port: LIVERELOAD_PORT), mountFolder(connect, yeomanConfig.docs)]
    ...
    grunt.registerTask "build", ["clean:dist", "useminPrepare", "concurrent:dist", "copy:dist", "cssmin", "concat", "usemin"]
